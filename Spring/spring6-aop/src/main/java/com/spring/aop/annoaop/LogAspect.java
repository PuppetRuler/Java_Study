...
public class LogAspect {
    ...
    @Before(value = "execution(public int com.spring.aop.annoaop.CalculatorImpl.*(..))")
    ...
    // 后置 @After()
    //@After(value = "com.spring.aop.annoaop.LogAspect.pointCut()")
    ...
    // 环绕 @Around()
    @Around("execution(* com.spring.aop.annoaop.CalculatorImpl.*(..))")
